 ...
 */
module.exports = function fetchrPlugin(options, fetchrClass) {
    fetchrClass = fetchrClass || Fetchr;
    options = options || {};
    ...
    return {
        ...
        registerService: function registerService(service) {
            fetchrClass.registerFetcher(service);
        },
        /**
